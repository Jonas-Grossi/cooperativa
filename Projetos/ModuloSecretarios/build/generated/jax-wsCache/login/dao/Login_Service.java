 ...
 * 
 */
@WebServiceClient(name = "login", targetNamespace = "http://Dao/", wsdlLocation = "http://192.168.173.1:8080/WebService/login?WSDL")
    ...
    extends Service
{
    ...
    private final static QName LOGIN_QNAME = new QName("http://Dao/", "login");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.173.1:8080/WebService/login?WSDL");
    ...
    public Login getLoginPort() {
        return super.getPort(new QName("http://Dao/", "loginPort"), Login.class);
    }
    ...
    public Login getLoginPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Dao/", "loginPort"), Login.class, features);
    }
